...
Diskrétní waveletová transformace rozkládá obraz na prostorově lokalizované vlnky. V tomto projektu je využita vlnka Daubechies 4 (db4), která umožňuje efektivní reprezentaci jak hrubých obrysů, tak jemných detailů, bez vysoké výpočetní náročnosti.
...
SVD & 29,22 & 0,770 & 28.33 & $k = 34$ \\
Wavelet (DWT) & 35,69 & 0,855 & 1.46  & level = 3 \\ \bottomrule
\end{tabular}
\end{table}
...
\section{Závěr}
Na základě provedených experimentů s různými typy a rozlišeními obrazků byly vyvozeny následující závěry
